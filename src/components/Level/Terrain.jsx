...
Command: npx gltfjsx@6.5.3 .\public\models\Terrain.gltf -o src/components/Level/Terrain.jsx 
*/
...
export function Terrain(props) {
  ...
  //const { nodes, materials } = useGLTF("/models/Terrain.gltf");
  const { nodes } = useGLTF("/models/Terrain.gltf");

  const size = useStore((state) => state.terrainSize);
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < vertexCount; i++) {
      ...
      heightData[index + 3] = normalizedHeight; // A (fully opaque)
    }
